...
from cerberus.static.external_modules.impacket import nmb, ntlm, uuid, crypto
from cerberus.static.external_modules.impacket.smb3structs import *
from cerberus.static.external_modules.impacket.nt_errors import STATUS_SUCCESS, STATUS_MORE_PROCESSING_REQUIRED, STATUS_INVALID_PARAMETER, \
    STATUS_NO_MORE_FILES, STATUS_PENDING, STATUS_NOT_IMPLEMENTED, ERROR_MESSAGES
from cerberus.static.external_modules.impacket.spnego import SPNEGO_NegTokenInit, TypesMech, SPNEGO_NegTokenResp, ASN1_OID, asn1encode, ASN1_AID
from cerberus.static.external_modules.impacket.krb5.gssapi import KRB5_AP_REQ
...
class SMB3:
    ...
    def kerberosLogin(self, user, password, domain = '', lmhash = '', nthash = '', aesKey='', kdcHost = '', TGT=None, TGS=None, mutualAuth=False):
        ...
        from cerberus.static.external_modules.impacket.krb5.asn1 import AP_REQ, Authenticator, TGS_REP, seq_set
        from cerberus.static.external_modules.impacket.krb5.kerberosv5 import getKerberosTGT, getKerberosTGS
        from cerberus.static.external_modules.impacket.krb5 import constants
        from cerberus.static.external_modules.impacket.krb5.types import Principal, KerberosTime, Ticket
...
#            pass
        ...
        if mutualAuth == True:
            from cerberus.static.external_modules.impacket.krb5.constants import APOptions
        ...
        if ans.isValidAnswer(STATUS_SUCCESS):
            ...
            if mutualAuth == True:
                ...
                from cerberus.static.external_modules.impacket.krb5.asn1 import AP_REP, EncAPRepPart
    ...
    def listPath(self, shareName, path, password = None):
        ...
        try:
            ...
            res = ''
            files = []
            from cerberus.static.external_modules.impacket import smb
            while True:
                try:
