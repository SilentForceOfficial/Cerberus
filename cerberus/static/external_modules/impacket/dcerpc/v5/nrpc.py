...
#   at https://github.com/fortra/cerberus.static.external_modules.impacket/tree/master/tests/SMB_RPC
#
...
from six import b
from cerberus.static.external_modules.impacket.dcerpc.v5.ndr import NDRCALL, NDRSTRUCT, NDRENUM, NDRUNION, NDRPOINTER, NDRUniConformantArray, \
    NDRUniFixedArray, NDRUniConformantVaryingArray
from cerberus.static.external_modules.impacket.dcerpc.v5.dtypes import WSTR, LPWSTR, DWORD, ULONG, USHORT, PGUID, NTSTATUS, NULL, LONG, UCHAR, PRPC_SID, \
    GUID, RPC_UNICODE_STRING, SECURITY_INFORMATION, LPULONG, ULONGLONG
from cerberus.static.external_modules.impacket import system_errors, nt_errors
from cerberus.static.external_modules.impacket.uuid import uuidtup_to_bin
from cerberus.static.external_modules.impacket.dcerpc.v5.enum import Enum
from cerberus.static.external_modules.impacket.dcerpc.v5.samr import OLD_LARGE_INTEGER
from cerberus.static.external_modules.impacket.dcerpc.v5.lsad import PLSA_FOREST_TRUST_INFORMATION
from cerberus.static.external_modules.impacket.dcerpc.v5.rpcrt import DCERPCException
from cerberus.static.external_modules.impacket.structure import Structure
from cerberus.static.external_modules.impacket import ntlm, crypto, LOG
import hmac
import hashlib
try:
...
# 2.2.1.1.2 STRING
from cerberus.static.external_modules.impacket.dcerpc.v5.lsad import STRING
...
from cerberus.static.external_modules.impacket.dcerpc.v5.samr import SAMPR_LOGON_HOURS
