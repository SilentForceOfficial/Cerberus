...
# For signing
from cerberus.static.external_modules.impacket import smb, nmb, ntlm, uuid
from cerberus.static.external_modules.impacket import smb3structs as smb2
from cerberus.static.external_modules.impacket.spnego import SPNEGO_NegTokenInit, TypesMech, MechTypes, SPNEGO_NegTokenResp, ASN1_AID, \
    ASN1_SUPPORTED_MECH
from cerberus.static.external_modules.impacket.nt_errors import STATUS_NO_MORE_FILES, STATUS_NETWORK_NAME_DELETED, STATUS_INVALID_PARAMETER, \
...
from cerberus.static.external_modules.impacket.dcerpc.v5.rpcrt import DCERPCServer
from cerberus.static.external_modules.impacket.dcerpc.v5.dtypes import NULL
from cerberus.static.external_modules.impacket.dcerpc.v5.srvs import NetrShareEnum, NetrShareEnumResponse, SHARE_INFO_1, NetrServerGetInfo, \
    NetrServerGetInfoResponse, NetrShareGetInfo, NetrShareGetInfoResponse
from cerberus.static.external_modules.impacket.dcerpc.v5.wkst import NetrWkstaGetInfo, NetrWkstaGetInfoResponse
from cerberus.static.external_modules.impacket.system_errors import ERROR_INVALID_LEVEL
