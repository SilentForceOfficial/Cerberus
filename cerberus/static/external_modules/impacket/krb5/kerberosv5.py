...
from cerberus.static.external_modules.impacket.krb5.asn1 import AS_REQ, AP_REQ, TGS_REQ, KERB_PA_PAC_REQUEST, KRB_ERROR, PA_ENC_TS_ENC, AS_REP, TGS_REP, \
...
from cerberus.static.external_modules.impacket.krb5.types import KerberosTime, Principal, Ticket
from cerberus.static.external_modules.impacket.krb5.gssapi import CheckSumField, GSS_C_DCE_STYLE, GSS_C_MUTUAL_FLAG, GSS_C_REPLAY_FLAG, \
    GSS_C_SEQUENCE_FLAG, GSS_C_CONF_FLAG, GSS_C_INTEG_FLAG
from cerberus.static.external_modules.impacket.krb5 import constants
from cerberus.static.external_modules.impacket.krb5.crypto import Key, _enctype_table, InvalidChecksum
from cerberus.static.external_modules.impacket.smbconnection import SessionError
...
from cerberus.static.external_modules.impacket import nt_errors, LOG
        ...
        try:
            ...
            if str(e).find('KDC_ERR_ETYPE_NOSUPP') >= 0:
                if lmhash == b'' and nthash == b'' and (aesKey == b'' or aesKey is None):
                    from cerberus.static.external_modules.impacket.ntlm import compute_lmhash, compute_nthash
