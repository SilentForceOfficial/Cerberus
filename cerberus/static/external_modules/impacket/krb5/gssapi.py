...
from cerberus.static.external_modules.impacket.krb5 import constants, crypto
...
class GSSAPI_RC4:
    ...
    def GSS_Wrap(self, sessionKey, data, sequenceNumber, direction = 'init', encrypt=True, authData=None):
        ...
        if authData is not None:
            from cerberus.static.external_modules.impacket.dcerpc.v5.rpcrt import SEC_TRAILER
