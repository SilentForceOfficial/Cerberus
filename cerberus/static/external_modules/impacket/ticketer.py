#!/usr/bin/env python
# cerberus.static.external_modules.impacket - Collection of Python classes for working with network protocols.
#
...
from cerberus.static.external_modules.impacket.dcerpc.v5.dtypes import RPC_SID, SID
from cerberus.static.external_modules.impacket.dcerpc.v5.ndr import NDRULONG
from cerberus.static.external_modules.impacket.dcerpc.v5.samr import NULL, GROUP_MEMBERSHIP, SE_GROUP_MANDATORY, SE_GROUP_ENABLED_BY_DEFAULT, \
    SE_GROUP_ENABLED, USER_NORMAL_ACCOUNT, USER_DONT_EXPIRE_PASSWORD
from cerberus.static.external_modules.impacket.examples import logger
from cerberus.static.external_modules.impacket.krb5.asn1 import AS_REP, TGS_REP, ETYPE_INFO2, AuthorizationData, EncTicketPart, EncASRepPart, EncTGSRepPart
from cerberus.static.external_modules.impacket.krb5.constants import ApplicationTagNumbers, PreAuthenticationDataTypes, EncryptionTypes, \
...
from cerberus.static.external_modules.impacket.krb5.keytab import Keytab
from cerberus.static.external_modules.impacket.krb5.crypto import Key, _enctype_table
from cerberus.static.external_modules.impacket.krb5.crypto import _checksum_table, Enctype
from cerberus.static.external_modules.impacket.krb5.pac import KERB_SID_AND_ATTRIBUTES, PAC_SIGNATURE_DATA, PAC_INFO_BUFFER, PAC_LOGON_INFO, \
    ...
    PAC_ATTRIBUTE_INFO
from cerberus.static.external_modules.impacket.krb5.types import KerberosTime, Principal
from cerberus.static.external_modules.impacket.krb5.kerberosv5 import getKerberosTGT, getKerberosTGS
...
class TICKETER:
    ...
    def saveTicket(self, ticket, sessionKey):
        ...
        # MODIFICADOOOO
        times=[ccache.credentials[0]['time']['starttime'],ccache.credentials[0]['time']['endtime']]
                
        return (times,ccache.getData())
    ...
    def run(self):
        ...
        if ticket is not None:
            ...
            # MODIFICADOOOO
            return self.saveTicket(ticket, sessionKey) 
