...
def add_from_relationship(
    ...
    for row in result:
        ...
        if "path" in tipo:
            # # NOTE: WE ARE ONLY GETTING THE FIRST RELATIONSHIP HEREs
            # relationship = list(elemento.relationships)[0]
            # node1 = __get_node(elemento.start_node, styled_graph)
            # node2 = __get_node(elemento.end_node, styled_graph)
